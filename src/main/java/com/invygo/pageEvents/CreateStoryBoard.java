...
ElementFetch elementfetch = new ElementFetch();
	...
	public void createStoryBoard() 
	{
		...
		String Text = "Old is Gold";
		elementfetch.getWebElement("XPATH",StoryBoardPageElements.typeInTextArea).sendKeys(Text);
		...
		Assert.assertEquals(elementfetch.getWebElement("XPATH",StoryBoardPageElements.previewText).getText(), Text);
    }
